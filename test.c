...
int main(int argc, char **argv) {
	...
	printf("test1: ");
	start = clock();
	check_equivalence("./bdds/var5.bdd", "./xbars/test1.xbar");
	end = clock();
	printf("Time: %.3f seconds\n", (double) (end - start) / CLOCKS_PER_SEC);
	printf("\n");
	printf("test2: ");
	start = clock();
	check_equivalence("./bdds/var5.bdd", "./xbars/test2.xbar");
	end = clock();
	printf("Time: %.3f seconds\n", (double) (end - start) / CLOCKS_PER_SEC);
	printf("\n");
	printf("test3: ");
	start = clock();
	check_equivalence("./bdds/var5.bdd", "./xbars/test3.xbar");
	end = clock();
	printf("Time: %.3f seconds\n", (double) (end - start) / CLOCKS_PER_SEC);
	printf("\n");
	printf("test4: ");
	start = clock();
	check_equivalence("./bdds/var5.bdd", "./xbars/test4.xbar");
	end = clock();
	printf("Time: %.3f seconds\n", (double) (end - start) / CLOCKS_PER_SEC);
	printf("\n");
	printf("test5: ");
	start = clock();
	check_equivalence("./bdds/var5.bdd", "./xbars/test5.xbar");
	end = clock();
	printf("Time: %.3f seconds\n", (double) (end - start) / CLOCKS_PER_SEC);
	printf("\n");
	printf("\n");
