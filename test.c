...
int main(int argc, char **argv) {
	...
	convert_BDD_to_crossbar("./bdds/var2.bdd", "./xbars2/var2.xbar");
	printf("\n");
	printf("Converting var5.bdd to var5.xbar...\n");
	convert_BDD_to_crossbar("./bdds/var5.bdd", "./xbars2/var5.xbar");
	printf("\n");
	printf("Converting var10.bdd to var10.xbar...\n");
	convert_BDD_to_crossbar("./bdds/var10.bdd", "./xbars2/var10.xbar");
	printf("\n");
	printf("Converting var15.bdd to var15.xbar...\n");
	convert_BDD_to_crossbar("./bdds/var15.bdd", "./xbars2/var15.xbar");
	printf("\n");
	printf("Converting var20.bdd to var20.xbar...\n");
	convert_BDD_to_crossbar("./bdds/var20.bdd", "./xbars2/var20.xbar");
	printf("\n");
	printf("Converting var25.bdd to var25.xbar...\n");
	convert_BDD_to_crossbar("./bdds/var25.bdd", "./xbars2/var25.xbar");
	printf("\n");
	printf("\n");
	printf("\n");
